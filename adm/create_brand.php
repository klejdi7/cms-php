...
if(isset($_POST['new']) && $_POST['brand_name'] != ""){
$brand->create_brand();
}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Krijo Brand</h1>
        ...
        <form method="post" style="margin:20px;">
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputEmail4">Emertimi Brandit</label>
              <input type="text" name="brand_name" class="form-control" id="inputEmail4" placeholder="e.g Nike">
            </div>
          </div>
