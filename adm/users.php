...
<i class="fas fa-book"></i>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="http://libraridyrrahu.com/book_check_adm">Produktet</a>
            <!-- <a class="collapse-item" href="utilities-animation.html">Animations</a> -->
            <a class="collapse-item" href="http://libraridyrrahu.com/adm_genres">Genret e Librave</a>
          </div>
        </div>
      </li>
      <!-- -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Perdorues</h1>
          <!-- <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p> -->

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Perdoures</h6>
            </div>
            <form style="margin: 15px 0px 0px 20px;width:30%;" >
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" placeholder="Kerko emer perdorues" aria-label="Search" aria-describedby="basic-addon2">
                <div class="input-group-append">
              ...
              <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td> <?php echo $user['created_at'] ?> </td>
                        <td>
                          ...
                          <a class="btn btn-primary" style="background-color: #ff3300;" href="/delete_element?user_id=<?php echo $user['user_id'];?>"> <i class="fas fa-trash-alt"></i> </a>
                            <?php endif ?>
                        </td>
                  ...
                  <?php endforeach?>
                    ...
                    <a href="/register" class="btn btn-primary noprint">Shto Perdorues <i class="fas fa-arrow-right"></i></a>
