...
$user->getUserData();
$prod = New Product;
$data = $prod->getAllProducts();

if(isset($_POST['search'])){
  $tm = $_POST['term'];
header("location: ?term=$tm");
}
      ...
      <!-- Artikuj -->
            <!-- <li class="nav-item">
              ...
              <div id="collapseUtilitiess" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item" href="/upload_product">Upload Artikull</a>
                  <a class="collapse-item" href=" ">Artikuj</a>
                </div>
              </div>
            </li> -->
            <!-- -->
...
<i class="fas fa-users"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        $term = $_GET['term'];
        $search = $prod->searchData($term);
         ?>
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Produktet e kerkuar</h6>
          </div>
          <form method="post" style="margin: 15px 0px 0px 20px;width:30%;" >
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" name="term" placeholder="Kerko rreth produkteve" aria-label="Search" aria-describedby="basic-addon2">
              <div class="input-group-append">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php if(!$search): ?>
                    <h3> Asnje produkt nuk figuron me kete emer </h3>
                  <?php else: ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary" href="/product/<?php echo $prod['product_id'];?>"> <i class="fas fa-info-circle fa-1x"></i> </a>
                      <a style="background-color: #ff3300;" class="btn btn-primary" href="/delete_element?prod_id=<?php echo $prod['product_id'];?>"> <i class="fas fa-trash-alt"></i> </a></td>
                    </td>
      ...
      <?php else: ?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Produktet</h6>
            </div>
            <form method="post" style="margin: 15px 0px 0px 20px;width:30%;" >
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" name="term" placeholder="Kerko rreth produkteve" aria-label="Search" aria-describedby="basic-addon2">
