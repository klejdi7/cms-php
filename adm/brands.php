        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <form style="margin: 15px 0px 0px 20px;width:30%;" >
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" placeholder="Kerko rreth Brandeve" aria-label="Search" aria-describedby="basic-addon2">
                <div class="input-group-append">
                  <button class="btn btn-primary" type="button">
                    <i class="fas fa-search fa-sm"></i>
                  </button>
                </div>
                <a class="btn btn-primary" style="margin-left:10px;" href="/new_br">Shto Brand <i class="fas fa-arrow-right"></i></a>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <a class="btn btn-primary" style="background-color: #ff3300;" href="/delete_element?brand_id=<?php echo $brand['brand_id'];?>"> <i class="fas fa-trash-alt"></i> </a></td>
