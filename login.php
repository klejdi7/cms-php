...
<head>
  ...
  <title>Brand Manager | Kyçu</title>

  <!-- Custom fonts for this template-->
  <link href="../admin/adm/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="../admin/adm/css/sb-admin-2.min.css" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="css/style.css">
    ...
    <body class="bg-primary">
        ...
        <script src="../admin/adm/vendor/jquery/jquery.min.js"></script>
        <script src="../admin/adm/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

        <!-- Core plugin JavaScript-->
        <script src="../admin/adm/vendor/jquery-easing/jquery.easing.min.js"></script>

        <!-- Custom scripts for all pages-->
        <script src="../admin/adm/js/sb-admin-2.min.js"></script>
    </body>
</html>
